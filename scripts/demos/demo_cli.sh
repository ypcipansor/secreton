#!/bin/bash
# 🖥️ Secreton CLI Demo Script
# Demonstrates the complete CLI functionality for both Transit and KV engines

set -e

echo "🖥️ ============================================"
echo "🖥️      SECRETON CLI COMPLETE DEMO"
echo "🖥️ ============================================"
echo

# Build CLI if needed
echo "📦 Building Secreton CLI..."
cargo build -p secreton-cli --quiet
CLI="./target/debug/secreton-cli"
...
CIPHERTEXT1=$($CLI transit encrypt app-key --data "Welcome to Secreton CLI!" | tail -n 1)
...
echo
echo "🚀 The Secreton CLI is production-ready!"
echo "🖥️  Use './target/debug/secreton-cli --help' for full command reference"
echo
