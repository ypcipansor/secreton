...
mod tests {
    ...
    fn test_falcon_sign_verify() {
        ...
        assert!(
            ...
            signature.len(), min_size, max_size
        );
    ...
    fn test_batch_operations() {
        ...
        let batch_signer = FalconBatchSigner::new(keypair.private_key.clone(), FalconVariant::Falcon512).unwrap();
        ...
        for sig in &signatures {
            assert!(
                ...
                "Signature size {} not in valid range [{}, {}]", sig.len(), min_size, max_size
            );
        }
    ...
    fn test_different_variants() {
        for variant in [FalconVariant::Falcon512, FalconVariant::Falcon1024] {
            ...
            assert!(
                ...
                variant, signature.len(), min_size, max_size
            );
