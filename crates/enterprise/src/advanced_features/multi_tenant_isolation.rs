...
impl MultiTenantEngine {
    ...
    pub async fn check_cross_tenant_access(
        ...
        for policy in policies.values() {
                ...
                && policy.enabled
            {
                ...
                // Check if _secret _path matches pattern
    ...
    /// Delete tenant and all associated _data
...
mod tests {
    ...
    async fn test_create_tenant() {
        ...
        assert_eq!(tenant._name, "Test Tenant");
    ...
    async fn test_cross_tenant_access_with_policy() {
        ...
        // Should allow with matching _path
        let allowed = engine
            .check_cross_tenant_access(
                &tenant1.tenant_id,
                &tenant2.tenant_id,
        ...
        // Should deny with non-matching _path
        let result = engine
            .check_cross_tenant_access(
                &tenant1.tenant_id,
                &tenant2.tenant_id,
