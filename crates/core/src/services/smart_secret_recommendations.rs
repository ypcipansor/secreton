...
impl SmartSecretRecommendations {
    ...
    pub async fn generate_recommendations(&self) -> Result<Vec<RotationRecommendation>> {
        ...
        for (path, analysis) in analyses.iter() {
            // Check age
            if let Some(created_at) = secret_ages.get(path) {
            ...
            if analysis.strength_score < score_threshold {
                recommendations.push(RotationRecommendation {
                    ...
                    priority: Priority::High,
                    reason: format!(
                        "Weak secret strength (score: {:.1}), consider strengthening",
            ...
            if analysis.strength_score < 50.0 {
                violations.push(BestPracticeViolation {
                    ...
                    remediation_steps: vec![
                        "Generate a stronger password with at least 16 characters".to_string(),
    ...
    fn is_common_password(&self, s: &str) -> bool {
        let common_passwords = vec!["password", "123456", "admin", "qwerty", "letmein"];
...
mod tests {
    ...
    async fn test_generate_recommendations() {
        ...
        recommender
            .register_secret_age("secret/old".to_string(), old_date)
            .await;

        recommender
            .analyze_secret_strength("secret/old".to_string(), "weak")
            .await
            .unwrap();
    ...
    async fn test_calculate_security_posture() {
        ...
        recommender
            .analyze_secret_strength("secret/strong".to_string(), "V3ry!Str0ng@P@ssw0rd!123")
            .await
            .unwrap();

        recommender
            .analyze_secret_strength("secret/weak".to_string(), "weak")
            .await
            .unwrap();
    ...
    async fn test_detect_violations() {
        ...
        recommender
            .analyze_secret_strength("secret/weak".to_string(), "123")
            .await
            .unwrap();
    ...
    async fn test_apply_recommendation() {
        ...
        recommender
            .analyze_secret_strength("secret/old".to_string(), "password")
            .await
            .unwrap();
